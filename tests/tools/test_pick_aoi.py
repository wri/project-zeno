...
@pytest.mark.parametrize("query, expected_id, expected_name, expected_type", load_test_data(get_sample_size()), scope="session")
...
def save_results_after_tests():
    ...
    fieldnames = ['query', 'expected_id', 'expected_name', 'expected_type', 
                  'actual_id', 'actual_name', 'actual_type', 'score']
