...
# Load the actual YAML to pull real instruction text
_YAML_PATH = Path(__file__).parent.parent.parent / "src" / "agent" / "tools" / "analytics_datasets.yml"
with open(_YAML_PATH) as f:
    _ALL_DATASETS = yaml.safe_load(f)["datasets"]
    ...
    "statistics": [
        Statistics(
            ...
            data={
                ...
                "area_ha": [
                    798045, 688012, 654321, 723456,
                    891034, 812345, 746231, 701234,
                ],
                "emissions_MgCO2e": [
                    354021, 302456, 289012, 318765,
                    395432, 360123, 331098, 310456,
                ],
                "aoi_id": ["BRA.14"] * 8,
                "aoi_type": ["admin"] * 8,
            },
    ...
    "statistics": [
        Statistics(
            ...
            data={
                ...
                "area_ha": [
                    4523100, 3214500, 2876400, 1543200,
                    234500, 187600, 412300, 98700,
                ],
                "emissions_MgCO2e": [
                    2012340, 1423560, 1278900, 687450,
                    104230, 83400, 183200, 43800,
                ],
                "aoi_id": ["IDN"] * 8,
                "aoi_type": ["admin"] * 8,
            },
...
# ---------------------------------------------------------------------------
_dist_months = ["2024-06", "2024-07", "2024-08", "2024-09", "2024-10", "2024-11"]
_dist_drivers = ["Conversion", "Fire-related", "Cropland dynamics", "Water-related", "Unclassified"]
        ...
        Statistics(
            ...
            data={
                "land_cover_class_start": [
                    ...
                    "Short vegetation", "Short vegetation",
                    "Cropland", "Cropland",
                    "Bare ground and sparse vegetation",
                ],
                "land_cover_class_end": [
                    "Cropland", "Short vegetation", "Built-up land",
                    "Cropland", "Tree cover",
                    "Built-up land", "Short vegetation",
                    "Short vegetation",
                ],
                "area_ha": [
                    1234567, 567890, 123456,
                    890123, 345678,
                    78901, 45678,
                    234567,
                ],
    ...
    "statistics": [
        Statistics(
            ...
            data={
                ...
                "area_ha": [
                    28456000, 28234000, 28012000, 27890000, 27678000,
                    27456000, 27234000, 27012000, 26890000, 26678000,
                    26456000, 26345000, 26234000, 26123000, 26012000,
                    25901000, 25790000, 25679000, 25568000, 25457000,
                    25346000, 25235000, 25124000,
                ],
                "aoi_id": ["KEN"] * 23,
                "aoi_type": ["admin"] * 23,
            },
...
NATURAL_LANDS_STATE = {
    ...
    "statistics": [
        Statistics(
            ...
            data={
                "natural_lands_class": [
                    "Natural forest", "Mangrove", "Natural peat forest",
                    "Wetland natural forest", "Natural short vegetation",
                    "Natural water", "Bare", "Snow",
                    "Crop", "Built-up", "Non-natural tree cover",
                    "Non-natural short vegetation",
                ],
                "class_id": [2, 5, 8, 9, 3, 4, 6, 7, 14, 15, 17, 18],
                "area_ha": [
                    34567890, 1234567, 890123, 2345678,
                    5678901, 1234567, 345678, 12345,
                    8901234, 2345678, 3456789, 1234567,
                ],
                "aoi_id": ["COL"] * 12,
                "aoi_type": ["admin"] * 12,
            },
    ...
    "statistics": [
        Statistics(
            ...
            data={
                ...
                "area_ha": [
                    0, 12345678, 8901234, 6789012,
                    5678901, 4567890, 5678901,
                    7890123, 9012345, 10123456, 11234567,
                ],
                "aoi_id": ["COD"] * 11,
                "aoi_type": ["admin"] * 11,
            },
    ...
    "statistics": [
        Statistics(
            ...
            data={
                ...
                "emissions_tCO2e": [
                    4567890, 123456, 45678,
                    2345678, 67890, 23456,
                    8901234, 234567, 89012,
                    1234567, 34567, 12345,
                    567890, 15678, 5678,
                ],
                ...
                "production_tonnes": [
                    10150000, 10150000, 10150000,
                    2634000, 2634000, 2634000,
                    7236000, 7236000, 7236000,
                    527000, 527000, 527000,
                    1673000, 1673000, 1673000,
                ],
                "year": [2024] * 15,
                "aoi_id": ["BRA"] * 15,
                "aoi_type": ["admin"] * 15,
