...
from experiments.eval_gadm import parse_expected_output
...
passing_cases = [
    ...
    (
        {"gadm_id": "CHE.9", "name": "Glarus Süd"},
        {"gadm_id": "CHE-9", "name": "Glarus Sud"},
    ),
    # this should pass, ignoring gadm level property right now
    (
        {"gadm_id": "GBR.1.83_1", "name": "Sheffield", "gadm_level": "1"},
        {"gadm_id": "GBR-1-83_1", "name": "Sheffield", "gadm_level": "3"},
    ),
]
