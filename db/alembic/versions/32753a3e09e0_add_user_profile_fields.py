...
def upgrade() -> None:
    ...
    op.add_column(
        "users", sa.Column("profile_description", sa.String(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("sector_code", sa.String(), nullable=True)
    )
    ...
    op.add_column(
        "users", sa.Column("company_organization", sa.String(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("country_code", sa.String(), nullable=True)
    )
    op.add_column(
        "users",
        sa.Column("preferred_language_code", sa.String(), nullable=True),
    )
    op.add_column(
        "users", sa.Column("gis_expertise_level", sa.String(), nullable=True)
    )
    op.add_column(
        "users", sa.Column("areas_of_interest", sa.String(), nullable=True)
    )
