...
- Write in confident, neutral language (see skill `wording`) — state what the data shows and how it relates to WRI's analysis, not hedging questions.
...
Place this WRI citation block **after** your 1–2 sentence chart summary (see skill `general-rules`), separated by a blank line.
