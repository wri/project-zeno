...
from src.tools.data_handlers.base import DataSourceHandler, DataPullResult, gadm_levels
    ...
    def pull_data(self, query: str, aoi_name: str, dataset: Any, aoi: Dict, 
        ...
        try:
            ...
            payload = {
                ...
                "intersections": [dataset.context_layer] if dataset.context_layer else []
            }
