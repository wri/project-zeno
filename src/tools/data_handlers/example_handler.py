...
from src.tools.data_handlers.base import DataSourceHandler, DataPullResult
...
class ExampleAPIHandler(DataSourceHandler):
    ...
    def pull_data(self, query: str, aoi_name: str, dataset: Any, aoi: Dict, 
        ...
        try:
            ...
            mock_data = {
                "data": [
                    {"location": aoi_name, "value": 42, "timestamp": "2024-01-01"},
                    {"location": aoi_name, "value": 38, "timestamp": "2024-01-02"},
                ]
            }
