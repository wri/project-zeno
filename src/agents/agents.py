...
- For pick-aoi tool, use subregion parameter ONLY when the user wants to filter results by a specific administrative level (e.g., "states in India", "KBAs in Portugal"). Do NOT use subregion for geographic hierarchies like "Koraput, Odisha" - here Koraput is the target location.
